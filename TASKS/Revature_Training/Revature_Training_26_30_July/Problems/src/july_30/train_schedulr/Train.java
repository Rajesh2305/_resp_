...
//		this.arriTime=aTime;
	...
	public void showDetails()
	{
		...
		System.out.println("-------------------------------------------");
		System.out.println(1+"       "+this.startingStation.showDetails());
		for(int i=0;i<5;i++)
		{
			System.out.println(i+2+"       "+this.stns[i].showDetails());
		}
		System.out.println(this.noOfStops+2+"       "+this.startingStation.showDetails());
	}
}
